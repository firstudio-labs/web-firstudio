...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Galeri /</span> Edit Galeri</h4>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('keterangan') is-invalid @enderror"
                                            id="keterangan" name="keterangan" value="{{ old('keterangan', $galeri->keterangan) }}" required>
                                        @error('keterangan')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('kategori_gambar_id') is-invalid @enderror" 
                                            ...
                                            @foreach ($kategori_gambars as $kategori_gambar)
                                                <option value="{{ $kategori_gambar->id }}" 
                                                    {{ old('kategori_gambar_id', $galeri->kategori_gambar_id) == $kategori_gambar->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Format: jpeg, png, jpg, gif, svg. Maksimal 2MB. Kosongkan jika tidak ingin mengubah gambar.</small>
                                        @error('gambar')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
