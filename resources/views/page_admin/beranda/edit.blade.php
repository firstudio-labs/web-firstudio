                        ...
                        <form action="{{ route('admin.beranda.update', $beranda->id) }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('judul_utama_en') is-invalid @enderror"
                                            id="judul_utama_en" name="judul_utama_en"
                                            value="{{ old('judul_utama_en', $beranda->judul_utama_en) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="judul_sekunder_en" name="judul_sekunder_en"
                                            value="{{ old('judul_sekunder_en', $beranda->judul_sekunder_en) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('slogan_en') is-invalid @enderror" id="slogan_en"
                                    name="slogan_en" value="{{ old('slogan_en', $beranda->slogan_en) }}">
                                @error('slogan_en')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('keterangan_en') is-invalid @enderror" id="keterangan_en"
                                    name="keterangan_en" rows="4">{{ old('keterangan_en', $beranda->keterangan_en) }}</textarea>
                                @error('keterangan_en')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
