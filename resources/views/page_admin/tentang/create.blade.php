...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tentang /</span> Tambah Tentang</h4>

        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Form Tambah Tentang</h5>
                    </div>
                    <div class="card-body">
                        @if (session('error'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi"
                                        name="deskripsi" rows="6" placeholder="Masukkan deskripsi" required></textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-2">
                                            <input type="number"
                                                ...
                                                name="hitungan[]" placeholder="Angka 1"  />
                                            @error('hitungan.0')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-3 mb-2">
                                            <input type="number"
                                                ...
                                                name="hitungan[]" placeholder="Angka 2"  />
                                            @error('hitungan.1')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-3 mb-2">
                                            <input type="number"
                                                ...
                                                name="hitungan[]" placeholder="Angka 3"  />
                                            @error('hitungan.2')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-3 mb-2">
                                            <input type="number"
                                                ...
                                                name="hitungan[]" placeholder="Angka 4"  />
                                            @error('hitungan.3')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-2">
                                            <input type="text"
                                                ...
                                                name="keterangan_hitungan[]" placeholder="Keterangan 1"  />
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <input type="text"
                                                ...
                                                name="keterangan_hitungan[]" placeholder="Keterangan 2"  />
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <input type="text"
                                                ...
                                                name="keterangan_hitungan[]" placeholder="Keterangan 3"  />
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <input type="text"
                                                ...
                                                name="keterangan_hitungan[]" placeholder="Keterangan 4"  />
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('keterangan_memilih') is-invalid @enderror"
                                        ...
                                        placeholder="Masukkan keterangan memilih" ></textarea>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control @error('keterangan_nilai') is-invalid @enderror"
                                        ...
                                        placeholder="Masukkan keterangan nilai" ></textarea>
    ...
    <script>
        ...
        ClassicEditor
            ...
            .then(newEditor => {
                ...
                // Hapus atribut required dari textarea asli setelah CKEditor siap
                const originalTextarea = document.querySelector('#deskripsi');
                originalTextarea.removeAttribute('required');
                
                // Validasi manual sebelum submit
                const form = document.querySelector('form');
                form.addEventListener('submit', function(e) {
                    const editorData = editorDeskripsi.getData();
                    if (!editorData.trim()) {
                        e.preventDefault();
                        alert('Deskripsi harus diisi!');
                        editorDeskripsi.editing.view.focus();
                        return false;
                    }
                });
            })
