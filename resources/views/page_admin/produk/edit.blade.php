                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                        id="judul" name="judul" value="{{ old('judul', $produk->judul) }}"
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="master_kategori_produk_id">Kategori Produk</label>
                                <div class="col-sm-10">
                                    <select class="form-select @error('master_kategori_produk_id') is-invalid @enderror"
                                        ...
                                        @foreach ($kategoriProduks as $kategori)
                                            <option value="{{ $kategori->id }}" 
                                                {{ old('master_kategori_produk_id', $produk->master_kategori_produk_id) == $kategori->id ? 'selected' : '' }}>
