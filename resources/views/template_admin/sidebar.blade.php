<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Request::is('admin/beranda*') ? 'active' : '' }}">
            <a href="{{ route('admin.beranda.index') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('admin/chatbot/*') ? 'active open' : '' }}">
            <a href="javascript:;" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-bot"></i>
                <div data-i18n="Analytics">Chatbot</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('admin/chatbot/sessions*') ? 'active' : '' }}">
                    <a href="{{ route('admin.chatbot.sessions.index') }}" class="menu-link">
                        <div data-i18n="Analytics">Riwayat Percakapan</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('admin/chatbot/faq*') ? 'active' : '' }}">
                    <a href="{{ route('admin.chatbot.faq.index') }}" class="menu-link">
                        <div data-i18n="Analytics">Knowledge Base</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item {{ Request::is('admin/tim*') ? 'active' : '' }}">
            <a href="{{ route('admin.tim.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-group"></i>
                <div data-i18n="Analytics">Tim</div>
            </a>
        </li>
