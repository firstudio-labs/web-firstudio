...
@section('content')
 ...
 <section class="hero-section bg-black px-6 py-20 text-white">
    ...
    <!-- Pricing Section -->
    <section id="pricing" class="bg-gray-50 px-6 py-20">
      <div class="mx-auto w-full max-w-6xl space-y-12">
        <div class="text-center space-y-4">
          <h2 class="font-primary text-3xl font-bold text-gray-900 md:text-4xl">
            Paket Harga Website Development
          </h2>
          <p class="font-secondary text-lg text-gray-600 max-w-2xl mx-auto">
        ...
        <div class="pricing-grid">
          <!-- Lite Package -->
          <div class="pricing-card flex flex-col h-full">
            <div class="mb-6">
              <h3 class="text-2xl font-bold text-gray-900">Paket Lite</h3>
              <p class="mt-2 text-gray-600">Desain Template - standar, efisien, dan fokus pada fitur esensial.</p>
            </div>
            <div class="mb-6">
              <p class="text-sm text-gray-500 mb-2">Mulai dari</p>
              <div class="flex items-baseline gap-2">
                <!-- <span class="text-lg text-gray-400 line-through">Rp 1.500.000</span> -->
                <span class="pricing-card__price">Rp 1.000.000</span>
              </div>
              <span class="text-gray-600">/ tahun pertama</span>
            </div>
            <ul class="mb-8 space-y-4 flex-grow">
              <li class="flex items-start gap-3">
                ...
                <span class="text-gray-700">Perpanjangan hanya Rp 300.000/thn</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Desain Template Modern - cepat dan efisien</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Fitur esensial untuk online presence dasar</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Halaman inti: Beranda, Tentang, Layanan, Kontak, Artikel/Blog & Galeri</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Mobile Responsive (Akses di HP)</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Gratis Hosting & SSL 1 Tahun</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
                <span class="text-gray-400">Exclude domain (beli terpisah)</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
                <span class="text-gray-400">Integrasi E-Commerce</span>
              </li>
            </ul>
            <a 
              href="https://api.whatsapp.com/send/?phone=62813277774528&text=Halo%2C%20saya%20tertarik%20dengan%20Paket%20Pro%20Website%20yang%20ditawarkan.%20Mohon%20informasinya%20ya!&type=phone_number&app_absent=0" 
          ...
          <!-- Pro Package -->
          <div class="pricing-card pricing-card--featured flex flex-col h-full">
            <div class="mb-6">
              <h3 class="text-2xl font-bold text-gray-900">Paket Pro</h3>
              <p class="mt-2 text-gray-600">Desain Custom - sederhana, fungsional, dan terlihat unik.</p>
            </div>
            <div class="mb-6">
              <p class="text-sm text-gray-500 mb-2">MULAI DARI</p>
              <div class="flex items-baseline gap-2">
                <!-- <span class="text-lg text-gray-400 line-through">Rp 3.500.000</span> -->
                <span class="pricing-card__price">Rp 2.000.000</span>
              </div>
              <span class="text-gray-600">/ tahun pertama</span>
            </div>
            <ul class="mb-8 space-y-4 flex-grow">
              <li class="flex items-start gap-3">
                ...
                <span class="text-gray-700">Perpanjangan hanya Rp 500.000/thn</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Semua fitur pada Paket Lite</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Include Domain (.COM / .ID) 1 Tahun</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Hingga 9 Halaman + Produk/Portofolio</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Desain Custom (Revisi 3x) - unik dan sederhana</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Optimasi SEO Dasar (Kecepatan & Indexing)</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Integrasi Google Analytics & Pixel</span>
              </li>
            </ul>
            <a 
              href="https://api.whatsapp.com/send/?phone=62813277774528&text=Halo%2C%20saya%20tertarik%20dengan%20Paket%20Pro%20Website%20yang%20ditawarkan.%20Mohon%20informasinya%20kak%20😊&type=phone_number&app_absent=0" 
              class="btn btn-outline btn-block" 
              target="_blank" 
              rel="noopener"
            >Pilih Paket</a>
          ...
          <div class="pricing-card flex flex-col h-full">
            <div class="mb-6">
              <h3 class="text-2xl font-bold text-gray-900">Paket X</h3>
              <p class="mt-2 text-gray-600">Desain Custom Penuh - fitur lanjutan & kompleks untuk kebutuhan spesifik.</p>
            </div>
            <div class="mb-6">
              <h3 class="text-3xl font-bold text-blue-600 mb-2">Hubungi Kami</h3>
              <p class="text-gray-600">Dapatkan penawaran sesuai kebutuhan</p>
            </div>
            <ul class="mb-8 space-y-4 flex-grow mt-12">
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Semua fitur pada Paket Pro</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Desain Custom Penuh & UX/UI mendalam</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Integrasi fitur spesifik & sistem pihak ketiga</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Sistem E-Commerce (Keranjang, Checkout)</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Pelatihan Pengelolaan Website Mendalam</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Dukungan Teknis Prioritas</span>
              </li>
              <li class="flex items-start gap-3">
                <svg class="h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <span class="text-gray-700">Include Domain 1 Tahun</span>
              </li>
            </ul>
            <a href="{{ route('web.contact.index') }}" class="btn btn-outline btn-block">Hubungi Kami</a>
          </div>
        </div>
        ...
        <div class="text-center">
          <p class="text-gray-600">
            Butuh paket kustom? 
            <a href="{{ route('web.contact.index') }}" class="font-semibold text-blue-500 hover:text-blue-600">Hubungi kami</a> 
